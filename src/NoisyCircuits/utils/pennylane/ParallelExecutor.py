...
@njit(fastmath=False)
def compute_trajectory_probs(sparse_matrix_list:list[tuple[np.ndarray, int, int]],
    ...
    Args:
        sparse_matrix_list (list[tuple[np.ndarray, int, int]]): List of sparse matrices representing the noise operators in CSR format.
